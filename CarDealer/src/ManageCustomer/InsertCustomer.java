...
public class InsertCustomer {
   ...
   /**
    * Utilises a prepared statement with a customer object (created with user input) in order to send the user input into the db and create a record on the customer table
    * @param customer - customer object built using user input in the manage customer gui
    */
