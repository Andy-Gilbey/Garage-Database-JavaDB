...
public class AddNewCarGui extends JFrame {
	...
	private static final long serialVersionUID = 5204041119145842591L;
	...
	public void initalise() {
        ...
        makeCombo.setModel(new DefaultComboBoxModel<>(new String[] { "Alfa Romeo", "Aston Martin", "Audi", "Apollo", "Bentley", "BMW", "Buick", "Cadillac", "Chevrolet", "Chrysler", "Citroen", "Dacia","Daewoo", "Fiat", "Ford", "Honda","Hummer","Hyundai", "Jaguar", "Jeep", "KIA", "Lamborghini", "Lexus","Lotus", "Land Rover", "Locus", "Lotec", "Maserati", "Mazda", "Mercedes", "MG", "Mitsubishi", "Nissan", "Opel/Vauxhall", "Peugeot", "Pontiac", "Porsche", "Puma", "Renault", "Rolls-Royce", "Saab","Sabaru","Seat","Skoda", "Scion", "Suzuki", "Smart", "Tesla", "Toyota", "Volkswagen", "Volvo", "Yamaha" }));
	...
	protected void saveBtnActionPerformed(ActionEvent e) {
		InsertCar insert = new InsertCar();
		Car car = new Car();
		car = buildCar();
		insert.carInsert(car);
